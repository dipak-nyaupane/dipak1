 <?php
  ...
  if ($QID=='EMPLOYEE_LIST1')  { $QRY = "SELECT * FROM user WHERE code='$P1' and ccode='$P2' "; }
  ...
  if ($QID=='EMPLOYEE_DESIGNATION1')  { $QRY = "SELECT * FROM user WHERE ccode='$P2' and code='$P1' ";  }

  if ($QID=='USER_INFO')  { $QRY = "SELECT * FROM user WHERE ccode='$P1'";}
  if ($QID=='USER_INFO1')  { $QRY = "SELECT * FROM user WHERE code='$P1' and ccode='$P2'"; }
