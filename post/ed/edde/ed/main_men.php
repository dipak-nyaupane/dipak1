...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="active"><a href="../main.php" style="margin-top:2px">
     <img src="../images/home.png" width="32"> Home 
...
<table width="100%"> 
    <tr><td><input type="text" class="form-control" id="SEARCH_TEXT" name="SEARCH_TEXT" placeholder="Search Employee" onchange="SEARCH_INFORMATION(this.value);"></td></tr>
	  ...
	  <img src="../images/logout.png" width=" <?php print $ICON; ?>"> Admin <span class="caret"></span></a>
          <ul class="dropdown-menu">
